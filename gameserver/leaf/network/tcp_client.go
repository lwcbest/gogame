...
func (client *TCPClient) init() {
	...
	// msg parser
	msgParser := NewPkgParser()
	client.pkgParser = msgParser
}
...
reconnect:
	...
	tcpConn := newTCPConn(conn, client.PendingWriteNum, client.pkgParser)
	agent := client.NewSession(tcpConn)
	agent.Run()
